          ...
          >
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    {r.pctRecommended && (
                      <span className="bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 border border-emerald-500/30 text-[10px] font-bold px-2 py-0.5 rounded-md flex items-center gap-1">
                        <ShieldCheck className="w-3 h-3 text-emerald-500" /> PCT Verified
                      </span>
                    )}
            ...
            <div className={`pt-2 border-t flex items-center justify-between gap-2 ${isDarkMode ? 'border-[#222232]' : 'border-slate-200'}`}>
              <button
                ...
                className={`flex-1 text-xs font-semibold py-2 px-3 rounded-xl transition-all flex items-center justify-center gap-1.5 border ${
                  isDarkMode 
